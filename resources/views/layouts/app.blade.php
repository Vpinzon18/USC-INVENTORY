            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <div x-data="{ open: {{ request()->routeIs('maintenances.*') || request()->routeIs('schedules.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open && sidebarOpen" 
                        ...
                        <a href="{{ route('schedules.index') }}" class="flex items-center p-2 rounded-md text-sm {{ request()->routeIs('schedules.*') ? 'text-blue-400 bg-[#2b2b40]' : 'text-gray-400' }} hover:text-white transition-colors">
