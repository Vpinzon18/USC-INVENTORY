                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="job_title_id" id="job_title_id" class="border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm block w-full mt-1 bg-white" required>
                                ...
                                <option value="{{ $job->id }}" {{ old('job_title_id', $custodian->job_title_id) == $job->id ? 'selected' : '' }}>
                                    {{ $job->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="dependency_id" id="dependency_id" class="border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm block w-full mt-1 bg-white" required>
                                ...
                                <option value="{{ $dep->id }}" {{ old('dependency_id', $custodian->dependency_id) == $dep->id ? 'selected' : '' }}>
                                    {{ $dep->name }}
                                </option>
                                @endforeach
                            </select>
