<x-app-layout>
    ...
    <div class="py-4 md:py-6 bg-slate-50 min-h-screen font-sans text-slate-800" x-data="dependencyEditor()" x-cloak>
        <div class="max-w-[1400px] w-full px-4 sm:px-6 lg:px-8 mx-auto space-y-4 md:space-y-6">
                ...
                <div class="flex items-center gap-4 md:gap-5 pl-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs md:text-sm font-medium text-slate-500 mt-1">
                            Actualice la información de la dependencia institucional utilizada en la organización y clasificación de los activos tecnológicos.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 md:gap-6 relative items-start">
                ...
                <div class="lg:col-span-8">
                    <form action="{{ route('dependencies.update', $dependency->id) }}" method="POST" id="updateDependencyForm" class="space-y-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="p-5 md:p-8 space-y-8">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input id="name" type="text" name="name" value="{{ old('name', $dependency->name) }}" required 
                                            placeholder="Ej: Dirección Administrativa, Coordinación Académica..." 
                                    ...
                                    <p class="text-[11px] font-medium text-slate-500 mt-2 flex items-center gap-1.5">
                                        ...
                                        El nombre de la dependencia será utilizado en la asignación de oficinas, custodios y activos tecnológicos dentro del sistema SIGMA.
                                    </p>
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative">
                            ...
                            <div class="p-6 pt-8">
                                ...
                                <div class="space-y-6">
                                    <div class="flex gap-3.5 items-start group">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[11px] font-medium text-slate-500 mt-1 leading-relaxed">Si modifica el nombre aquí, se actualizará dinámicamente en todos los custodios, oficinas y activos relacionados que compartan esta dependencia.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex gap-3.5 items-start group">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[11px] font-medium text-slate-500 mt-1 leading-relaxed">Los cambios se reflejarán de inmediato en los selectores del sistema y en los reportes de inventario.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 pt-5 border-t border-slate-100 text-center">
                                    ...
                                    <p class="text-xs font-bold text-slate-600">{{ method_exists($dependency, 'updated_at') && $dependency->updated_at ? $dependency->updated_at->format('d M Y - h:i A') : 'Fecha no registrada' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('dependencyEditor', () => ({
                isSubmitting: false,

                confirmUpdate() {
                    const form = document.getElementById('updateDependencyForm');
                    ...
                    Swal.fire({
                        ...
                        html: `Está a punto de modificar esta dependencia en el sistema SIGMA.<br><br><span class="text-sm font-medium text-slate-500">Los cambios se verán reflejados en todos los registros vinculados a ella.</span>`,
                        icon: 'question',
