        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="p-6 md:p-8 border-b border-slate-200 bg-slate-50 flex flex-col sm:flex-row sm:items-center gap-4">
                    <div class="p-3 bg-indigo-100 text-indigo-600 rounded-xl w-fit">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    </div>
                    <div>
                        <h2 class="font-extrabold text-2xl text-slate-800 tracking-tight">Registrar Nuevo Bloque</h2>
                        <p class="text-xs text-slate-500 mt-1 font-medium">Asigne un nuevo bloque o edificio a una de sus sedes existentes.</p>
                    </div>
                </div>

                <form method="POST" action="{{ route('buildings.store') }}" class="p-6 md:p-8 flex flex-col gap-6">
                    @csrf
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 p-6 shadow-sm transition-all hover:shadow-md flex flex-col gap-5">
                        ...
                        <div>
                            ...
                            <select name="campus_id" id="campus_id" required autofocus
                                ...
                                <option value="" disabled {{ old('campus_id') ? '' : 'selected' }}>-- Seleccione la Sede --</option>
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-slate-400 mt-2 flex items-center gap-1">
                                ...
                                Se utilizará para agrupar salones y oficinas.
                            </p>
                        </div>
