<x-app-layout>
    ...
    @php
        // Resolvemos el nombre inicial de la sede en caso de que la validación falle y usemos old()
        $initialId = old('campus_id');
        $initialName = '';
    ...
    <div class="py-6 bg-slate-50 min-h-screen font-sans text-slate-800" x-data="buildingCreator('{{ $initialId }}', '{{ addslashes($initialName) }}')" x-cloak>
        <div class="max-w-[1400px] w-[96%] mx-auto space-y-6">
                ...
                <div class="flex items-center gap-5 pl-2">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-slate-500 mt-1">
                            Registre un nuevo bloque, edificio o zona física perteneciente a una sede institucional.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 relative items-start">
                ...
                <div class="lg:col-span-8">
                    <form action="{{ route('buildings.store') }}" method="POST" id="createBuildingForm" class="space-y-6">
                        @csrf
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                            ...
                            <div class="p-8 space-y-8">
                                ...
                                <div>
                                    ...
                                    <p class="text-[11px] font-medium text-slate-500 mt-2 flex items-center gap-1.5">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                        Los bloques inactivos no estarán disponibles para nuevas asignaciones.
                                    </p>
                                    @error('status')
                                        <p class="text-[11px] font-bold text-rose-600 mt-1.5 flex items-center gap-1"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="px-8 py-5 bg-slate-50 border-t border-slate-100 flex flex-col-reverse sm:flex-row justify-end items-center gap-4">
                                ...
                                <!-- Interceptado con SweetAlert2 usando type="button" -->
                                ...
                                <div class="space-y-6">
                                    <div class="flex gap-3.5 items-start group">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[11px] font-medium text-slate-500 mt-1 leading-relaxed">Los bloques permiten agrupar múltiples oficinas y salones dentro de una misma sede institucional.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex gap-3.5 items-start group">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[11px] font-medium text-slate-500 mt-1 leading-relaxed">Una vez guardado, este bloque aparecerá disponible para la creación de nuevas oficinas y distribuciones.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex gap-3.5 items-start group">
                                        ...
                                        <div>
                                            <p class="text-xs font-extrabold text-slate-800 tracking-tight">Asignación de Activos</p>
                                            <p class="text-[11px] font-medium text-slate-500 mt-1 leading-relaxed">Fundamental para el mapeo físico de los equipos tecnológicos en el sistema de inventario.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('buildingCreator', (initialId, initialName) => ({
                isSubmitting: false,
                campusOpen: false,
                campusSearch: '',
                ...
                confirmCreate() {
                    ...
                    Swal.fire({
                        ...
                        html: `Está a punto de registrar un nuevo bloque en el sistema.<br><br><span class="text-sm font-medium text-slate-500">Asegúrese de que el nombre y la sede elegida sean correctos.</span>`,
                        icon: 'question',
