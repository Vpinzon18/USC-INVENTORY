<x-app-layout>
    ...
    <div class="py-6 bg-slate-50 min-h-screen font-sans text-slate-800" x-data="roomTypeCreator()" x-cloak>
        <div class="max-w-[1400px] w-[96%] mx-auto space-y-6">
                ...
                <div class="flex items-center gap-5 pl-2">
                    ...
                    <div>
                        <h2 class="font-extrabold text-2xl text-slate-900 tracking-tight flex items-center gap-3">
                            ...
                            <span class="bg-blue-50 text-blue-700 border border-blue-200 text-[10px] px-3 py-1 rounded-full font-bold uppercase tracking-widest shadow-sm">
                                Nuevo Registro
                            </span>
                        </h2>
                        <p class="text-sm font-medium text-slate-500 mt-1">
                            Añada una nueva clasificación al sistema para categorizar oficinas, aulas y laboratorios.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 relative items-start">
                ...
                <div class="lg:col-span-8">
                    <form action="{{ route('admin.room_types.store') }}" method="POST" id="createRoomTypeForm" class="space-y-6">
                        @csrf
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                            ...
                            <div class="p-8 space-y-8">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input id="name" type="text" name="name" value="{{ old('name') }}" required 
                                            placeholder="Ej: Laboratorio, Sala de Sistemas, Coworking..." 
                                    ...
                                    <p class="text-[11px] font-medium text-slate-500 mt-2 flex items-center gap-1.5">
                                        ...
                                        Este nombre aparecerá en los selectores al crear nuevas oficinas.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="3" placeholder="Ej: Espacios dedicados exclusivamente a la docencia e investigación..." 
                                        class="w-full bg-slate-50 border-slate-200 text-slate-800 text-sm font-bold placeholder:font-normal placeholder:text-slate-400 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 shadow-inner hover:bg-white transition-all py-3.5 px-4 resize-none">{{ old('description') }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select name="is_active" id="is_active" required
                                            ...
                                            <option value="1" {{ old('is_active', '1') == '1' ? 'selected' : '' }}>🟢 Activo (Visible en todo el sistema)</option>
                                            <option value="0" {{ old('is_active') == '0' ? 'selected' : '' }}>🔴 Inactivo (Oculto para nuevos registros)</option>
                                        </select>
                            ...
                            <div class="p-6 pt-8">
                                ...
                                <div class="space-y-6">
                                    <div class="flex gap-3.5 items-start group">
                                        ...
                                        <div>
                                            <p class="text-xs font-extrabold text-slate-800 tracking-tight">Escalabilidad de SIGMA</p>
                                            <p class="text-[11px] font-medium text-slate-500 mt-1 leading-relaxed">Este módulo evita valores estáticos. Permite adaptar SIGMA a cualquier futura infraestructura de la universidad sin tocar código.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            Alpine.data('roomTypeCreator', () => ({
                ...
                confirmCreate() {
                    ...
                    Swal.fire({
                        ...
                        html: `Está a punto de crear una nueva categoría base en el sistema SIGMA.<br><br><span class="text-sm font-medium text-slate-500">Esta opción estará disponible globalmente al crear nuevas ubicaciones.</span>`,
                        icon: 'question',
