            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-100">
                ...
                <div class="p-6 bg-white border-b border-gray-100">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                        ...
                        <a href="{{ route('jobtitles.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:border-indigo-900 focus:ring ring-indigo-300 transition ease-in-out duration-150 shadow-sm" style="text-decoration: none;">
                    ...
                    <form method="GET" action="{{ route('jobtitles.index') }}" class="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div class="relative w-full sm:w-80">
                            ...
                            <input type="text" name="search" value="{{ $search }}" placeholder="Buscar cargo..." class="bg-gray-50 border border-gray-200 text-gray-800 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 p-2.5 shadow-sm placeholder-gray-400" autocomplete="off" onkeyup="if(event.key === 'Enter') this.form.submit()">
                        </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50/70 border-b border-gray-200">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-4 font-bold text-gray-900">Nombre del Cargo</th>
                            ...
                            <tr class="bg-white hover:bg-gray-50/80 transition ease-in-out duration-150">
                                ...
                                <td class="px-6 py-4 text-right pr-6">
                                    <div class="flex justify-end items-center gap-2">
                                        <a href="{{ route('jobtitles.edit', $jobtitle->id) }}" class="inline-flex items-center px-3 py-1.5 bg-amber-50 text-amber-700 hover:bg-amber-100 border border-amber-200 rounded-lg text-xs font-bold tracking-wide transition ease-in-out duration-150" style="text-decoration: none;">
                            ...
                            <tr class="bg-white">
                                <td colspan="3" class="px-6 py-12 text-center text-sm text-gray-400 font-medium">
                                    <div class="flex flex-col items-center justify-center gap-2">
                                        ...
                                        <span>No se encontraron cargos registrados.</span>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
