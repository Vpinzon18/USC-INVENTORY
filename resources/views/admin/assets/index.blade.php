                    ...
                    <table class="w-full text-sm text-left">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 border-b">
                            <tr>
                                ...
                                <th class="px-6 py-4">Responsable Actual</th>
                                <th class="px-6 py-4">Hardware (CPU/RAM)</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($assets as $asset)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-gray-600 font-medium italic">{{ $asset->hostname ?? 'N/A' }}</td>
                                    <td class="px-6 py-4">
                                        <span class="px-2 py-1 bg-slate-100 text-slate-700 rounded text-xs font-bold uppercase">
                                            {{ $asset->room->nomenclatura ?? 'No asignado' }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-gray-900 font-medium">{{ $asset->currentCustodian->full_name ?? 'Sin responsable' }}</div>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex justify-center space-x-2">
                                            <a href="{{ route('assets.show', $asset) }}" class="text-gray-600 hover:bg-gray-100 p-2 rounded-lg" title="Ver Hoja de Vida">
                                            ...
                                            <a href="{{ route('assets.edit', $asset) }}" class="text-blue-600 hover:bg-blue-50 p-2 rounded-lg" title="Editar">
