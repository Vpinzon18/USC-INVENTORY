                ...
                <div class="flex items-center gap-4 md:gap-5 pl-2">
                    ...
                    <div>
                        <h2 class="font-extrabold text-xl md:text-2xl text-slate-900 tracking-tight flex flex-wrap items-center gap-2 md:gap-3">
                            ...
                            <span class="bg-blue-50 text-blue-700 text-[9px] md:text-[10px] px-2.5 md:px-3 py-1 rounded-full font-bold uppercase tracking-widest shadow-sm border border-blue-200 whitespace-nowrap">
                                Nuevo Registro
                            </span>
                        </h2>
                ...
                <div class="lg:col-span-8">
                    <form action="{{ route('rooms.store') }}" method="POST" id="createRoomForm" class="space-y-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 relative z-20">
                            ...
                            <!-- 🌟 SOLUCIÓN: px-5 md:px-8 para que en móvil no quite tanto espacio lateral -->
                            ...
                            <!-- 🌟 SOLUCIÓN: p-5 md:p-8 y gap-5 md:gap-8 para que los inputs no se sobrepongan -->
